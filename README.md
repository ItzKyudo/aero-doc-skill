...
### 2. Run the helper manually to verify
...
### 3. Trigger via Antigravity

The skill is registered to fire automatically on `on_commit` and on changes to `src/**/*`, `prompts/**/*`, and `.agents/skills/**/*`. The Antigravity agent will invoke it and write the updated docs to `docs/AGENT_MANUAL.md`.
